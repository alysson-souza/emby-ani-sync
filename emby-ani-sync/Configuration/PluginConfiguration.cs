...
namespace emby_ani_sync.Configuration
{
    /// <summary>
    ...
    public class PluginConfiguration : BasePluginConfiguration
    {
        ...
        /// <summary>
        /// Overriden callback URL set if the user is using Emby over the internet. Generally should not be set if the user is on LAN.
        /// </summary>
