...
namespace emby_ani_sync.Models.Kitsu
{
    public class KitsuUpdate
    {
        public class Attributes
        {
            ...
            [JsonPropertyName("reconsuming")]
            public bool? Reconsuming { get; set; }

            [JsonPropertyName("reconsumeCount")]
            public int? ReconsumeCount { get; set; }

            [JsonPropertyName("progressedAt")]
        ...
        public class AnimeData
        {
            ...
            public KitsuSearch.KitsuAnime? Anime { get; set; }
        }

        public class UserData
        {
            [JsonPropertyName("data")]
            public KitsuGetUser.KitsuUser? User { get; set; }
        }
        ...
        {
            [JsonPropertyName("data")]
            public List<KitsuLibraryEntry>? Data { get; set; }
        }

        public class KitsuLibraryEntryPostPatchRoot
        {
            [JsonPropertyName("data")]
            public KitsuLibraryEntry? Data { get; set; }
        }
    }
}
