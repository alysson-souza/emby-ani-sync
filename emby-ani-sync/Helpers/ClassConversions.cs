    ...
    public class ClassConversions
    {
        public static Anime ConvertAniListAnime(AniListSearch.Media aniListAnime)
        {
            Anime anime = new Anime
            {
                ...
                AlternativeTitles = new AlternativeTitles
                {
                    ...
                    Synonyms = new List<string> { { aniListAnime.Title.Romaji }, { aniListAnime.Title.UserPreferred } },
                },
            };
            ...
            if (aniListAnime.MediaListEntry != null)
            {
                anime.MyListStatus = new MyListStatus
                {
                    ...
                    IsRewatching =
                        aniListAnime.MediaListEntry.MediaListStatus == AniListSearch.MediaListStatus.Repeating,
                };
            }
            ...
            if (aniListAnime.Relations != null)
                ...
                {
                    RelatedAnime relatedAnime = new RelatedAnime { Anime = ConvertAniListAnime(relation.Media) };
        ...
        public static Anime ConvertKitsuAnime(KitsuSearch.KitsuAnime kitsuAnime)
        {
            Anime anime = new Anime
            {
                ...
                AlternativeTitles = new AlternativeTitles
                {
                    ...
                    Synonyms = new List<string> { kitsuAnime.Attributes.Slug, kitsuAnime.Attributes.CanonicalTitle },
                },
            };
        ...
        public static Anime ConvertAnnictAnime(AnnictSearch.AnnictAnime annictAnime)
        {
            Anime anime = new Anime
            {
                ...
                MyListStatus =
                    annictAnime.ViewerStatusState == AnnictSearch.AnnictMediaStatus.No_state
                        ? null
                        : new MyListStatus(),
            };
        ...
        {
            return new MalApiCalls.User { Id = id, Name = name };
        }
        ...
        public static Anime ConvertShikimoriAnime(ShikimoriAnime shikimoriAnime)
        {
            ...
            if (shikimoriAnime.Related != null)
            {
                anime.RelatedAnime = new List<RelatedAnime>();
                foreach (
                    ShikimoriRelated shikimoriRelated in shikimoriAnime.Related.Where(related => related.Anime != null)
                )
                {
        ...
        public static Anime ConvertSimklAnime(
            SimklExtendedMedia simklExtendedMedia,
            SimklUserEntry simklUserEntry = null
        )
        {
            Anime anime = new Anime
            {
