...
using emby_ani_sync.Models.Annict;
using emby_ani_sync.Models.Kitsu;
using emby_ani_sync.Models.Mal;
using emby_ani_sync.Models.Shikimori;
using emby_ani_sync.Models.Simkl;
...
namespace emby_ani_sync.Helpers
{
    public class ApiCallHelpers : IApiCallHelpers
    {
        ...
        public ApiCallHelpers(
            MalApiCalls malApiCalls = null,
        ...
        {
            bool updateNsfw =
                Plugin.Instance?.PluginConfiguration?.updateNsfw != null
                && Plugin.Instance.PluginConfiguration.updateNsfw;
            if (_malApiCalls != null)
            {
                return await _malApiCalls.SearchAnime(
                    query,
                    new[] { "id", "title", "alternative_titles", "num_episodes", "status" },
                    updateNsfw
                );
            }
        ...
        internal static List<Anime> ShikimoriSearchAnimeConvertedList(List<ShikimoriAnime> animeList, bool updateNsfw)
        {
            ...
            if (animeList != null)
            {
                ...
                {
                    if (!updateNsfw && shikimoriAnime.IsCensored == true)
                        continue;
        ...
        internal List<Anime> AniListSearchAnimeConvertedList(List<AniListSearch.Media> animeList, bool updateNsfw)
        {
            ...
            if (animeList != null)
            {
                ...
                {
                    if (!updateNsfw && media.IsAdult)
                        continue; // Skip NSFW anime if the user doesn't want to update them
                    var synonyms = new List<string> { { media.Title.Romaji }, { media.Title.UserPreferred } };
        ...
        public async Task<Anime> GetAnime(int id, string? alternativeId = null, bool getRelated = false)
        {
            if (_malApiCalls != null)
            {
                return await _malApiCalls.GetAnime(
                    id,
                    new[] { "title", "related_anime", "my_list_status", "num_episodes" }
                );
            }
        ...
        internal async Task<MyListStatus> GetConvertedKitsuUserList(int id)
        {
            ...
            if (userId != null)
            {
                KitsuUpdate.KitsuLibraryEntry userAnimeStatus = await _kitsuApiCalls.GetUserAnimeStatus(
                    userId.Value,
                    id
                );
        ...
        public async Task<Anime> GetAnime(
            AnimeOfflineDatabaseHelpers.OfflineDatabaseResponse ids,
            string title,
            bool getRelated = false
        )
        {
            if (_simklApiCalls != null)
            {
                ...
                if (idLookupResult != null && (idLookupResult.Ids?.Simkl != null && idLookupResult.Ids.Simkl != 0))
                {
                    ...
                    {
                        return ClassConversions.ConvertSimklAnime(
                            detailedAnime,
                            userList?.FirstOrDefault(userEntry => userEntry.Show.Ids.Simkl == detailedAnime.Ids.Simkl)
                        );
                    }
                }
            }
        ...
        public async Task<UpdateAnimeStatusResponse> UpdateAnime(
            int animeId,
            ...
            AnimeOfflineDatabaseHelpers.OfflineDatabaseResponse ids = null,
            bool? isShow = null
        )
        {
            if (_malApiCalls != null)
            {
                return await _malApiCalls.UpdateAnimeStatus(
                    animeId,
            ...
            if (_aniListApiCalls != null)
            {
                ...
                switch (status)
                {
                    ...
                    case Status.Completed:
                        anilistStatus =
                            isRewatching != null && isRewatching.Value
                                ? AniListSearch.MediaListStatus.Repeating
                                : AniListSearch.MediaListStatus.Completed;
                        break;
                    case Status.On_hold:
                ...
                if (
                    await _aniListApiCalls.UpdateAnime(
                        animeId,
                        anilistStatus,
                        numberOfWatchedEpisodes,
                        numberOfTimesRewatched,
            ...
            if (_kitsuApiCalls != null)
            {
                ...
                if (
                    await _kitsuApiCalls.UpdateAnimeStatus(
                        animeId,
                        numberOfWatchedEpisodes,
                        kitsuStatus,
                        isRewatching,
            ...
            if (_shikimoriApiCalls != null && alternativeId != null)
            {
                ...
                if (
                    await _shikimoriApiCalls.UpdateAnime(
                        alternativeId,
        ...
        public async Task<MalApiCalls.User> GetUser()
        {
            ...
            if (_kitsuApiCalls != null)
            {
                ...
                if (user != null)
                    return new MalApiCalls.User { Id = user.Value };
            }
            ...
            if (_annictApiCalls != null)
            {
                ...
                if (user != null)
                    return new MalApiCalls.User { Name = user.AnnictSearchData.Viewer.username };
            }
            ...
            if (_shikimoriApiCalls != null)
            {
                ...
                if (user != null)
                {
                    return new MalApiCalls.User { Id = user.Id, Name = user.Name };
                }
            }
        ...
        public async Task<List<Anime>> GetAnimeList(Status status, int? userId = null)
        {
                        ...
                        if (lastIndex != -1)
                        {
                            ...
                            if (media.CompletedAt is { Year: { }, Month: { }, Day: { } })
                            {
                                finishDate = new DateTime(
                                    media.CompletedAt.Year.Value,
                                    media.CompletedAt.Month.Value,
                                    media.CompletedAt.Day.Value
                                );
                            }
            ...
            if (_kitsuApiCalls != null && userId != null)
            {
                ...
                KitsuUpdate.KitsuLibraryEntryListRoot animeList = await _kitsuApiCalls.GetUserAnimeList(
                    userId.Value,
                    status: kitsuStatus
                );
                if (animeList != null)
                {
                    ...
                    foreach (KitsuUpdate.KitsuLibraryEntry kitsuLibraryEntry in animeList.Data)
                    {
                        ...
                        if (
                            kitsuLibraryEntry.Relationships != null
                        ...
                        if (kitsuLibraryEntry.Attributes != null)
                        {
                            ...
                            {
                                toAddAnime.MyListStatus.NumEpisodesWatched = kitsuLibraryEntry
                                    .Attributes
                                    .Progress
                                    .Value;
                            }
