...
public class AnimeOfflineDatabaseHelperTests
{
    ...
    public async Task DeserializeMetadataCall()
    {
            ...
            new List<Helpers.HttpCall>
            {
                new()
                {
                    ...
                    ResponseContent = JsonSerializer.Serialize(
                        new AnimeOfflineDatabaseHelpers.OfflineDatabaseResponse
                        {
                            AniDb = 1,
                            Anilist = 1,
                            Kitsu = 1,
        ...
        AnimeOfflineDatabaseHelpers.OfflineDatabaseResponse? result =
            await AnimeOfflineDatabaseHelpers.GetProviderIdsFromMetadataProvider(
                _httpClient,
                _logger,
                1,
                AnimeOfflineDatabaseHelpers.Source.Myanimelist
            );
