...
public class Kitsu
{
    ...
    private void Setup(List<Helpers.HttpCall> httpCalls)
    {
        ...
        _kitsuApiCalls = new KitsuApiCalls(
            _httpClientFactory,
            _loggerFactory,
            ...
            new UserConfig
            {
                ...
                {
                    new KeyPairs { Key = "KitsuUserId", Value = 1.ToString() },
                },
            }
        );
    }
            ...
            new List<Helpers.HttpCall>
            {
                new()
                {
                    ...
                    ResponseContent = JsonSerializer.Serialize(
                        new KitsuSearch.KitsuSearchMedia
                        {
                            KitsuSearchData = new List<KitsuSearch.KitsuAnime> { new() { Id = 1 } },
                        }
                    ),
                },
            }
        ...
        Setup(
            new List<Helpers.HttpCall>
            {
                new()
                {
                    ...
                    ResponseCode = HttpStatusCode.OK,
                    ResponseContent = JsonSerializer.Serialize(
                        new KitsuGetUser.KitsuUserRoot
                        {
                            KitsuUserList = new List<KitsuGetUser.KitsuUserData>
                            {
                                ...
                                {
                                    Id = 1,
                                    KitsuUser = new KitsuGetUser.KitsuUser { Id = 2, Name = String.Empty },
                                },
                            },
                        }
                    ),
        ...
        Setup(
            new List<Helpers.HttpCall>
            {
                new()
                {
                    ...
                    ResponseCode = HttpStatusCode.OK,
                    ResponseContent = JsonSerializer.Serialize(
                        new KitsuGet.KitsuGetAnime { KitsuAnimeData = new KitsuSearch.KitsuAnime { Id = id } }
                    ),
                },
            }
        );
                    ...
                    ResponseContent = JsonSerializer.Serialize(
                        new KitsuUpdate.KitsuLibraryEntryListRoot
                        {
                            Data = new List<KitsuUpdate.KitsuLibraryEntry>
                            {
                                ...
                                {
                                    Id = 1,
                                    Attributes = new KitsuUpdate.Attributes { Progress = 1 },
                                },
                            },
                        }
                    ),
    ...
    public async Task TestUpdateAnimeStatusWithoutFetchingUserId()
    {
        ...
        var result = await _kitsuApiCalls.UpdateAnimeStatus(
            1,
            1,
        ...
        Setup(
            new List<Helpers.HttpCall>
            {
                new()
                {
                    ...
                    ResponseCode = HttpStatusCode.OK,
                    ResponseContent = JsonSerializer.Serialize(
                        new KitsuMediaRelationship.MediaRelationship
                        {
                            ...
                            {
                                new() { Id = 1, RelationType = KitsuMediaRelationship.RelationType.sequel },
                            },
                        }
                    ),
                },
