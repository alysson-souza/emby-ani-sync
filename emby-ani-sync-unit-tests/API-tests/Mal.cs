...
public class Mal
{
        ...
        Setup(
            new List<Helpers.HttpCall>
            {
                new()
                {
                    ...
                    ResponseCode = HttpStatusCode.OK,
                    ResponseContent = JsonSerializer.Serialize(
                        new SearchAnimeResponse
                        {
                            Data = new List<AnimeList> { new() { Anime = new Anime { Id = 1 } } },
                        }
                    ),
                },
            }
        ...
        Setup(
            new List<Helpers.HttpCall>
            {
                new()
                {
                    ...
                    ResponseCode = HttpStatusCode.OK,
                    ResponseContent = JsonSerializer.Serialize(new Anime { Id = animeId }),
                },
            }
        );
    ...
    public async Task TestUpdateAnimeStatus()
    {
        ...
        var makeChange = await _malApiCalls.UpdateAnimeStatus(
            339,
            1,
            Status.Completed,
            isRewatching: true,
