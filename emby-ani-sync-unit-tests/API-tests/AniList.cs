...
public class AniList
{
    ...
    private void Setup(List<Helpers.HttpCall> httpCalls)
    {
        ...
        _aniListApiCalls = new AniListApiCalls(
            _httpClientFactory,
            _loggerFactory,
            ...
            new List<Helpers.HttpCall>
            {
                new()
                {
                    ...
                    ResponseContent = JsonSerializer.Serialize(
                        new AniListSearch.AniListSearchMedia
                        {
                            Data = new AniListSearch.AniListSearchData
                            {
                                Page = new AniListSearch.Page
                                {
                                    Media = new List<AniListSearch.Media> { new() { Id = 1 } },
                                    PageInfo = new AniListSearch.PageInfo { HasNextPage = false },
                                },
                            },
                        }
                    ),
        ...
        Setup(
            new List<Helpers.HttpCall>
            {
                new()
                {
                    ...
                    ResponseCode = HttpStatusCode.OK,
                    ResponseContent = JsonSerializer.Serialize(
                        new AniListViewer.AniListGetViewer
                        {
                            Data = new AniListViewer.AniListViewerData { Viewer = new AniListViewer.Viewer { Id = 1 } },
                        }
                    ),
                },
            }
    ...
    public async Task TestUpdatingAnime()
    {
        ...
        var result = await _aniListApiCalls.UpdateAnime(
            1,
                    ...
                    ResponseContent = JsonSerializer.Serialize(
                        new AniListSearch.AniListSearchMedia
                        {
                            Data = new AniListSearch.AniListSearchData
                            {
                                ...
                                {
                                    Media = new List<AniListSearch.Media> { new() { Id = 1 } },
                                    PageInfo = new AniListSearch.PageInfo { HasNextPage = true },
                                },
                            },
                        }
                    ),
        ...
        Setup(
            new List<Helpers.HttpCall>
            {
                new()
                {
                    ...
                    ResponseCode = HttpStatusCode.OK,
                    ResponseContent = JsonSerializer.Serialize(
                        new AniListGet.AniListGetMedia
                        {
                            Data = new AniListGet.AniListGetData { Media = new AniListSearch.Media { Id = 1 } },
                        }
                    ),
                },
            }
