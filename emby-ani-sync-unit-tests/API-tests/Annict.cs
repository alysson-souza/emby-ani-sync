...
public class Annict
{
    ...
    private void Setup(List<Helpers.HttpCall> httpCalls)
    {
        ...
        _annictApiCalls = new AnnictApiCalls(
            _httpClientFactory,
            _loggerFactory,
            ...
            new List<Helpers.HttpCall>
            {
                new()
                {
                    ...
                    ResponseContent = JsonSerializer.Serialize(
                        new AnnictSearch.AnnictSearchMedia
                        {
                            AnnictSearchData = new AnnictSearch.AnnictSearchData
                            {
                                SearchWorks = new AnnictSearch.SearchWorks
                                {
                                    Nodes = new List<AnnictSearch.AnnictAnime> { new() { Id = String.Empty } },
                                },
                            },
                        }
                    ),
        ...
        Setup(
            new List<Helpers.HttpCall>
            {
                new()
                {
                    ...
                    ResponseCode = HttpStatusCode.OK,
                    ResponseContent = JsonSerializer.Serialize(
                        new AnnictViewer.AnnictViewerRoot
                        {
                            AnnictSearchData = new AnnictViewer.AnnictViewerData
                            {
                                Viewer = new AnnictViewer.AnnictViewerDetails { username = String.Empty },
                            },
                        }
                    ),
                },
        ...
        Setup(
            new List<Helpers.HttpCall>
            {
                new()
                {
                    ...
                    ResponseCode = HttpStatusCode.OK,
                    ResponseContent = JsonSerializer.Serialize(
                        new AnnictMediaList.AnnictUserMediaList
                        {
                            AnnictSearchData = new AnnictMediaList.AnnictUserMediaListData
                            {
                                Viewer = new AnnictMediaList.AnnictUserMediaListViewer
                                {
                                    AnnictUserMediaListLibraryEntries =
                                        new AnnictMediaList.AnnictUserMediaListLibraryEntries
                                        {
                                            Nodes = new List<AnnictSearch.AnnictAnime> { new() { Id = String.Empty } },
                                            PageInfo = new AnnictMediaList.PageInfo { HasNextPage = false },
                                        },
                                },
                            },
                        }
